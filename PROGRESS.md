...
| S4-3-c-R7-a | ⬜ | 스코프 유틸 최소 구현 (R6-B-3 선행) | `src/lib/auth/scope.ts` (`getUserScope`, `applyScopeFilter`, `assertScopeAccess`). 감사서 §10-17, §11-1 근거 |
