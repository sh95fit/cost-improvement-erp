...
| S4-3-c-R6-B-3 | ⬜ | Layer B UI 라인업 선택 + 스코프 필터 | 감사서 §10-14 근거. `consumption-layer-b-editor.tsx` 재설계. **R7-a 선행 필수** (§10-17) |
