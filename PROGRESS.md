...
>
> 마지막 갱신: 2026-07-21 (Sprint 4 Phase S4-3-c R0·R1·R2 완료 — R0 감사서 편입 확정, R1 Shipping 잔재 검증 및 에러 문구 정합화, R2 발주단위 개념 폐기·미노출 UX 다이얼로그 3종 폐기·"이론량" → "제안 사용량" 라벨 정합화. c-4-3 legacy Phase 표기 5곳은 R3 batch rename 에 병합 예정. 상세 감사 이력: `docs/audits/2026-07-21-consumption-receiving-audit.md`)
