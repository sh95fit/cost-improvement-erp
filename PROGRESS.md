...
>
> 마지막 갱신: 2026-07-08 (Sprint 3.5 Phase S3.5-0·S3.5-1 완료. 다음: Phase S3.5-2 수동 발주 UI)
...
- **최근 완료 항목**: Sprint 3.5 Phase S3.5-0 (스키마 보강, 커밋 `95112583`) · Phase S3.5-1 (서비스·스키마·액션 라인업 검증 확장 + 레거시 픽스처 정리, 커밋 `95112583`·`8ac522b`)
- **다음 착수 항목**: **Sprint 3.5 Phase S3.5-2 (수동 발주 UI)** → S3.5-3 (테스트·문서) → Sprint 4 Phase S4-0
