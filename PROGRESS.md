...
| S4-3-c-R6  | ✅ | 가용재고 정본 서비스 | `available-stock.service.ts` 신설 (P16 공식, aggregate-level, breakdown 4필드) + 단위 테스트 7종 · R6-Pre §10 신설 (`ad9469c`) · R6-Pre 정정 §10 SK 정합 D-R6-f α (`a53a29c`) · R6-Pre-2 `[referenceType, referenceId]` 복합 인덱스 D-R6-e α (`ec03f73`) · R6-A 서비스+테스트 (본 커밋) |
