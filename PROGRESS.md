...
| S4-3-c-R15 | ⬜ | MealPlan CANCELLED 전이 시 활성 Reservation 일괄 release | 감사서 §9-5 근거. `MealPlanStatus.CANCELLED` 트리거 → 대상 MR 참조 Reservation 전수 `releaseReservation`. 2026-07-23 신설 |
