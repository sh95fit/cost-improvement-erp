...
>
> 마지막 갱신: 2026-07-13 (Sprint 4 Phase S4-1-e 완료 — createPurchaseOrdersBatchSchema 에 purchaseKind 통합 + WIZARD/MANUAL_JIT/STOCK_KEEPING 정합성 검증)
...
- 서비스 실체(`PurchaseOrder.create` 시 purchaseKind 저장)는 S4-1-e-2 에서 후속 진행 (UI S4-1-a/b 완료 후 통합)
