...
>
> 마지막 갱신: 2026-07-20 (Sprint 4 Phase S4-3-c-4-2 완료 — buildConsumptionDraft 라인업/라인 세분화 + 발주단위 노출 완료. 다음: S4-3-c-4-3 Smart Consumption Row UI + 폐기 자동 계산 + confirmConsumption 서비스 확장을 단일 원자적 커밋으로 진행)
