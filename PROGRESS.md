...
| S4-3-c-R6-B-1 | ⬜ | ConsumptionItem 스키마 확장 (`lineupId` NOT NULL + FK + 인덱스) | 감사서 §10-15 근거. Prisma 마이그레이션 (guard 포함) + `SCHEMA_COVERAGE.md` 갱신. Q6 즉시 NOT NULL 도입 (§9-12-b 정황증거) |
