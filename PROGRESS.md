...
>
> 마지막 갱신: 2026-07-09 (Sprint 3.5 종결. 다음: Sprint 4 Phase S4-0)
...
- **현재 진행 중 Sprint**: 없음 (Sprint 3.5 종결, Sprint 4 착수 대기)
...
- **최근 완료 항목**:
  - Sprint 3.5 Phase S3.5-3 (테스트·문서, 2026-07-09) ✅
  - Sprint 3.5 종결 아카이브 (`docs/progress/SPRINT3.5.md`) ✅
- **다음 착수 항목**: **Sprint 4 Phase S4-0 (스키마 보강 게이트)** — S4-0-a `InventoryTransaction` 부자재 지원, S4-0-b `InventoryReservation` 활성화, S4-0-c `AuditLog` 헬퍼 표준화
