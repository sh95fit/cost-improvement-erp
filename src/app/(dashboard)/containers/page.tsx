...
export default function ContainersPage() {
  ...
  const handleConfirmDelete = async () => {
    ...
    if (type === "group") {
      ...
      if (result.success && groupId) await refreshGroup(groupId);
    }
                        ...
                        <TableCell colSpan={7} className="p-0 border-t-0">
                          <div className="border-t border-blue-100 bg-blue-50/30 px-6 py-4 space-y-3">
                            <div className="flex items-center justify-between">
                              <span className="text-xs font-semibold text-gray-500">슬롯 구성</span>
                              <Button
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 mt-2">
            <div className="space-y-1">
              ...
              <Input placeholder="예: 밥, 국, 반찬1, 반찬2" value={newSlotName}
            ...
            <div className="space-y-1">
              ...
              <Input type="number" placeholder="예: 300" value={newSlotVolume}
